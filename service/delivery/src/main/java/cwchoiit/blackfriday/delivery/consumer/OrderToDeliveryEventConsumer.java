package cwchoiit.blackfriday.delivery.consumer;

import cwchoiit.blackfriday.delivery.eventhandler.EventHandler;
...
public class OrderToDeliveryEventConsumer {
    private final List<EventHandler<? extends EventPayload>> eventHandlers;

    @KafkaListener(topics = {ORDER_TO_DELIVERY})
