package cwchoiit.blackfriday.payment.consumer;

import cwchoiit.blackfriday.event.Event;
import cwchoiit.blackfriday.event.payload.EventPayload;
import cwchoiit.blackfriday.payment.eventhandler.EventHandler;
...
public class OrderToPaymentEventConsumer {
    private final List<EventHandler<? extends EventPayload>> eventHandlers;

    @KafkaListener(topics = {ORDER_TO_PAYMENT})
